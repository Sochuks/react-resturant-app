...
const Hero = () => {
  return (
    <section className='relative w-full px-6 pb-14 md:pb-2 -mr-2 md:mr-0 overflow-hidden'>
        {/* overlay
        ...
        <div className='md:grid md:grid-cols-10 flex flex-col-reverse items-center justify-center mx-auto px-2'>
            ...
            <div className='md:col-span-5 relative md:-ml-36'>
                ...
                <div className='flex items-center md:translate-x-72'>
                    {/* circle one */}
                    <div className='hidden outline-2 outline bg-successColor/85 outline-bgColor 
                    border-8 border-secColor/95 outline-offset-[20px] xl:block
                    rounded-[100%] md:h-[300px] my-10 md:py-2 md:w-[300px] z-10 md:-mr-28 '>
                        <img src="./src/assets/img/banner-image-three.png" alt="" className='' />
                    </div>

                    {/* Circle two */}
                    <div className='outline outline-2 outline-bgColor shadow-md shadow-darkColor/60 
